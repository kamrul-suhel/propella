<?php
    ...
    class CorsMiddleware
    {
        ...
        protected function setOrigin($req, $rsp) {
            // prepare the current origin address - default to site for debug purposes but set to false if live environment
            $origin = isset($_SERVER['HTTP_ORIGIN']) && !empty($_SERVER['HTTP_ORIGIN']) ? $_SERVER['HTTP_ORIGIN'] : 'http://app.propella.hostings.co.uk';
